...
package com.shehroz.msk.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "myApi/v1/jokegetter/";
  ...
  public class GetJoke extends MyApiRequest<com.shehroz.msk.builditbigger.backend.myApi.model.JokeGetter> {
    ...
    protected GetJoke(java.lang.String name) {
      super(MyApi.this, "GET", REST_PATH, null, com.shehroz.msk.builditbigger.backend.myApi.model.JokeGetter.class);
